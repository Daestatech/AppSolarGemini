...
urlpatterns = [
    ...
    path('clientes/arquivados/', ClienteInativoListView.as_view(), name='cliente_inativo_list'),
    path('cliente/<int:pk>/reativar/', ClienteReativarView.as_view(), name='cliente_reativar'),
]